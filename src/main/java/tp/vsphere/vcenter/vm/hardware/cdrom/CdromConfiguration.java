 ...
 */
package tp.vsphere.vcenter.vm.hardware.cdrom;

import tp.vsphere.common.SamplesAbstractBase;
import tp.vsphere.vcenter.helpers.VmHelper;
...
public class CdromConfiguration extends SamplesAbstractBase {
    ...
    protected void run() throws Exception {
        ...
        createCdromForAdapterType(HostBusAdapterType.SATA,
        ...
        System.out.println("\n\n### Example: Create IDE CD-ROM with"
                           + " CLIENT_DEVICE backing");
        createCdromForAdapterType(HostBusAdapterType.IDE,
            CdromTypes.BackingType.CLIENT_DEVICE);
    ...
    private void createCdromForAdapterType(
        HostBusAdapterType hostBusAdapterType,
